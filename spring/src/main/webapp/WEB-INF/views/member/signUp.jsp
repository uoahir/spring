...
<jsp:include page ="/WEB-INF/views/common/header.jsp" >
	...
	<section>
		<div id="enroll-container">
			<%-- <form name="memberEnrollFrm" method="post" action="${pageContext.request.contextPath }/member/signupend.do" >
				...
				<input type="password" class="form-control" placeholder="비밀번호확인" id="password2" name="password2" required>
			...
			<springform:form 
				...
				name="memberEnrollFrm" method="post" action="${pageContext.request.contextPath }/member/signupend.do" >
				<springform:input path="userId"
				type="text" class="form-control" placeholder="아이디 (4글자이상)" name="userId" id="userId_" />
				<springform:errors path="userId" cssClass="error" />
				
				<springform:input path="password" 
				type="password" class="form-control" placeholder="비밀번호" name="password" id="password_" />
				<springform:errors path="password" cssClass="error" />
				
				<input type="password" class="form-control" placeholder="비밀번호확인" id="password2" name="password2" />
				
				<springform:input path="userName" 
				type="text" class="form-control" placeholder="이름" name="userName" id="userName" />
				<springform:errors path="userName" cssClass="error" />
				
				<springform:input path="age"
				type="number" class="form-control" placeholder="나이" name="age" id="age" />
				<springform:errors path="age" cssClass="error" />
				
				
				<springform:input path="email"
				type="text" class="form-control" placeholder="이메일" name="email" id="email" />
				<springform:errors path="email" cssClass="error" />
				
				
				<springform:input path="phone"
				type="tel" class="form-control" placeholder="전화번호 (예:01012345678)" name="phone" id="phone" maxlength="11" />
				<springform:errors path="phone" cssClass="error" />
				
				<springform:input path="address" 
				type="text" class="form-control" placeholder="주소" name="address" id="address" />
